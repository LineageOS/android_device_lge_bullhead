...
BOARD_KERNEL_TAGS_OFFSET := 0x00000100U
BOARD_RAMDISK_OFFSET     := 0x00200100
BOARD_SECOND_OFFSET      := 0xFF100100
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_KERNEL_TAGS_OFFSET) --kernel_offset $(BOARD_KERNEL_OFFSET) --second_offset $(BOARD_SECOND_OFFSET)
